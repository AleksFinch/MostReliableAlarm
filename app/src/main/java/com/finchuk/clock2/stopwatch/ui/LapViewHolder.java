...
public class LapViewHolder extends BaseViewHolder<Lap> {
    ...
    @Bind(com.finchuk.clock2.R.id.lap_number) TextView mLapNumber;
    @Bind(com.finchuk.clock2.R.id.elapsed_time) ChronometerWithMillis mElapsedTime;
    @Bind(com.finchuk.clock2.R.id.total_time) TextView mTotalTime;

    public LapViewHolder(ViewGroup parent) {
        super(parent, com.finchuk.clock2.R.layout.item_lap, null);
    }
