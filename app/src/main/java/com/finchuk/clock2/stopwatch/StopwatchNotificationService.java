...
package com.finchuk.clock2.stopwatch;
...
import com.finchuk.clock2.chronometer.ChronometerDelegate;
import com.finchuk.clock2.chronometer.ChronometerNotificationService;
import com.finchuk.clock2.stopwatch.ui.StopwatchFragment;
import com.finchuk.clock2.util.ContentIntentUtils;
import com.finchuk.clock2.stopwatch.data.AsyncLapsTableUpdateHandler;
...
public class StopwatchNotificationService extends ChronometerNotificationService {
    ...
    public static final String ACTION_ADD_LAP = "com.finchuk.clock2.stopwatch.action.ADD_LAP";
    public static final String ACTION_UPDATE_LAP_TITLE = "com.finchuk.clock2.stopwatch.action.UPDATE_LAP_TITLE";

    public static final String EXTRA_LAP_NUMBER = "com.finchuk.clock2.stopwatch.extra.LAP_NUMBER";
    ...
    public void onCreate() {
        super.onCreate();
        setContentTitle(getNoteId(), getString(com.finchuk.clock2.R.string.stopwatch));
    ...
    protected int getSmallIcon() {
        return com.finchuk.clock2.R.drawable.ic_stopwatch_24dp;
    }
    ...
    protected int getNoteId() {
        return com.finchuk.clock2.R.id.stopwatch_notification_service;
    }
...
//        stopSelf();
    ...
    protected void handleAction(@NonNull String action, Intent intent, int flags, int startId) {
        if (ACTION_ADD_LAP.equals(action)) {
            ...
            setContentTitle(getNoteId(), getString(com.finchuk.clock2.R.string.stopwatch_and_lap_number, lapNumber));
    ...
    private void syncNotificationWithStopwatchState(boolean running) {
        ...
        addAction(ACTION_ADD_LAP, com.finchuk.clock2.R.drawable.ic_add_lap_24dp, getString(com.finchuk.clock2.R.string.lap), getNoteId());
