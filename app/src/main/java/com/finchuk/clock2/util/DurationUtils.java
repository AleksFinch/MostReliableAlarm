...
package com.finchuk.clock2.util;
...
public class DurationUtils {
    ...
    private static int getStringRes(long numDays, long numHours, long numMins) {
        ...
        if (numDays == 0) {
            if (numHours == 0) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.less_than_one_minute;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.minute;
                } else {
                    res = com.finchuk.clock2.R.string.minutes;
                }
            } else if (numHours == 1) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.hour;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.hour_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.hour_and_minutes;
                }
            } else {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.hours;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.hours_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.hours_and_minutes;
                }
            }
        } else if (numDays == 1) {
            if (numHours == 0) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.day;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.day_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.day_and_minutes;
                }
            } else if (numHours == 1) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.day_and_hour;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.day_hour_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.day_hour_and_minutes;
                }
            } else {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.day_and_hours;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.day_hours_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.day_hours_and_minutes;
                }
            }
        } else {
            if (numHours == 0) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.days;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.days_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.days_and_minutes;
                }
            } else if (numHours == 1) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.days_and_hour;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.days_hour_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.days_hour_and_minutes;
                }
            } else {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.days_and_hours;
                } else if (numMins == 1) {
                    res = com.finchuk.clock2.R.string.days_hours_and_minute;
                } else {
                    res = com.finchuk.clock2.R.string.days_hours_and_minutes;
                }
            }
        }
        return res;
    ...
    private static int getAbbreviatedStringRes(long numDays, long numHours, long numMins) {
        ...
        if (numDays == 0) {
            if (numHours == 0) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.abbrev_less_than_one_minute;
                } else {
                    res = com.finchuk.clock2.R.string.abbrev_minutes;
                }
            } else {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.abbrev_hours;
                } else {
                    res = com.finchuk.clock2.R.string.abbrev_hours_and_minutes;
                }
            }
        } else {
            if (numHours == 0) {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.abbrev_days;
                } else {
                    res = com.finchuk.clock2.R.string.abbrev_days_and_minutes;
                }
            } else {
                if (numMins == 0) {
                    res = com.finchuk.clock2.R.string.abbrev_days_and_hours;
                } else {
                    res = com.finchuk.clock2.R.string.abbrev_days_hours_and_minutes;
                }
            }
        }
        return res;
