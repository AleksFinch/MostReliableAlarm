...
public class AlarmRingtoneService extends RingtoneService<Alarm> {
    ...
    private static final String ACTION_SNOOZE = "com.finchuk.clock2.ringtone.action.SNOOZE";
    private static final String ACTION_DISMISS = "com.finchuk.clock2.ringtone.action.DISMISS";
    ...
    protected Notification getForegroundNotification() {
        String title = getRingingObject().label().isEmpty()
                ? getString(com.finchuk.clock2.R.string.alarm)
                : getRingingObject().label();
        return new NotificationCompat.Builder(this)
                // Required contents
                .setSmallIcon(com.finchuk.clock2.R.drawable.ic_alarm_24dp)
                .setContentTitle(title)
                .setContentText(TimeFormatUtils.formatTime(this, System.currentTimeMillis()))
                .addAction(com.finchuk.clock2.R.drawable.ic_snooze_24dp,
                        getString(com.finchuk.clock2.R.string.snooze),
                        getPendingIntent(ACTION_SNOOZE, getRingingObject().getIntId()))
                .addAction(com.finchuk.clock2.R.drawable.ic_dismiss_alarm_24dp,
                        getString(com.finchuk.clock2.R.string.dismiss),
