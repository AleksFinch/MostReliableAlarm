...
package com.finchuk.clock2.ringtone;
...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    public static final String ACTION_FINISH = "com.finchuk.clock2.ringtone.action.FINISH";
    public static final String EXTRA_RINGING_OBJECT = "com.finchuk.clock2.ringtone.extra.RINGING_OBJECT";
    public static final String ACTION_SHOW_SILENCED = "com.finchuk.clock2.ringtone.action.SHOW_SILENCED";

    private static boolean sIsAlive = false;
    private T mRingingObject;

    @Bind(com.finchuk.clock2.R.id.title) TextView mHeaderTitle;
    @Bind(com.finchuk.clock2.R.id.auto_silenced_container) LinearLayout mAutoSilencedContainer;
    @Bind(com.finchuk.clock2.R.id.auto_silenced_text) TextView mAutoSilencedText;
    @Bind(com.finchuk.clock2.R.id.ok) Button mOkButton;
    @Bind(com.finchuk.clock2.R.id.buttons_container) LinearLayout mButtonsContainer;
    @Bind(com.finchuk.clock2.R.id.btn_text_left) TextView mLeftButton;
    @Bind(com.finchuk.clock2.R.id.btn_text_right) TextView mRightButton;
    ...
    protected int getAutoSilencedDrawable() {
        return com.finchuk.clock2.R.drawable.ic_error_outline_96dp;
    }
    ...
    @OnClick(com.finchuk.clock2.R.id.btn_left)
    protected abstract void onLeftButtonClick();

    @OnClick(com.finchuk.clock2.R.id.btn_right)
    ...
    protected final int layoutResId() {
        return com.finchuk.clock2.R.layout.activity_ringtone;
    }
