...
package com.finchuk.clock2.ringtone.playback;
...
import com.finchuk.clock2.timers.TimerController;
import com.finchuk.clock2.timers.TimerNotificationService;
...
public class TimerRingtoneService extends RingtoneService<Timer> {
    ...
    protected Uri getRingtoneUri() {
        String ringtone = PreferenceManager.getDefaultSharedPreferences(this).getString(
                getString(com.finchuk.clock2.R.string.key_timer_ringtone), Settings.System.ALARM_ALERT);
...
//        PendingIntent pi = PendingIntent.getActivity(this, 0, intent, 0);
        return new NotificationCompat.Builder(this)
                ...
                .setContentText(getString(com.finchuk.clock2.R.string.times_up))
                .setSmallIcon(com.finchuk.clock2.R.drawable.ic_timer_24dp)
                .setShowWhen(false) // TODO: Should we show this?
//                .setOngoing(true) // foreground notes are ongoing by default
                .addAction(com.finchuk.clock2.R.drawable.ic_add_24dp,
                        getString(com.finchuk.clock2.R.string.add_one_minute),
                        getPendingIntent(ACTION_ADD_ONE_MINUTE, getRingingObject().getIntId()))
                .addAction(com.finchuk.clock2.R.drawable.ic_stop_24dp,
                        getString(com.finchuk.clock2.R.string.stop),
...
//                .setContentIntent(pi)
    ...
    protected boolean doesVibrate() {
        return PreferenceManager.getDefaultSharedPreferences(this).getBoolean(
                getString(com.finchuk.clock2.R.string.key_timer_vibrate), false);
    }

    @Override
    protected int minutesToAutoSilence() {
        String value = PreferenceManager.getDefaultSharedPreferences(this).getString(
                getString(com.finchuk.clock2.R.string.key_timer_silence_after), "15");
