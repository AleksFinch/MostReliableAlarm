...
import com.finchuk.clock2.timers.ui.CountdownChronometer;
import com.finchuk.clock2.ringtone.playback.TimerRingtoneService;
...
public class TimesUpActivity extends RingtoneActivity<Timer> {
    ...
    protected int getAutoSilencedText() {
        return com.finchuk.clock2.R.string.timer_auto_silenced_text;
    }

    @Override
    protected int getLeftButtonText() {
        return com.finchuk.clock2.R.string.add_one_minute;
    }

    @Override
    protected int getRightButtonText() {
        return com.finchuk.clock2.R.string.stop;
    }

    @Override
    protected int getLeftButtonDrawable() {
        return com.finchuk.clock2.R.drawable.ic_add_48dp;
    }

    @Override
    protected int getRightButtonDrawable() {
        return com.finchuk.clock2.R.drawable.ic_stop_48dp;
    }
    ...
    private void postExpiredTimerNote() {
        Notification note = new NotificationCompat.Builder(this)
                .setContentTitle(getString(com.finchuk.clock2.R.string.timer_expired))
