...
import com.finchuk.clock2.alarms.data.AlarmsListCursorLoader;
...
import com.finchuk.clock2.alarms.data.AlarmCursor;
import com.finchuk.clock2.alarms.data.AsyncAlarmsTableUpdateHandler;
import com.finchuk.clock2.dialogs.TimePickerDialogController;
import com.finchuk.clock2.list.RecyclerViewFragment;
import com.finchuk.clock2.util.DelayedSnackbarHandler;

import static com.finchuk.clock2.util.FragmentTagUtils.makeTag;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.finchuk.clock2.alarms.extra.SCROLL_TO_ALARM_ID";
