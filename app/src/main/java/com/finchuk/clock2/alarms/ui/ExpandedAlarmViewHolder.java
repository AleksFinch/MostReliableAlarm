...
import com.finchuk.clock2.alarms.misc.DaysOfWeek;
import com.finchuk.clock2.dialogs.RingtonePickerDialog;
import com.finchuk.clock2.dialogs.RingtonePickerDialogController;
...
public class ExpandedAlarmViewHolder extends BaseAlarmViewHolder {
    ...
    @Bind(com.finchuk.clock2.R.id.ok) Button mOk;
    @Bind(com.finchuk.clock2.R.id.delete) Button mDelete;
    @Bind(com.finchuk.clock2.R.id.ringtone) Button mRingtone;
    @Bind(com.finchuk.clock2.R.id.vibrate) TempCheckableImageButton mVibrate;
    @Bind({com.finchuk.clock2.R.id.day0, com.finchuk.clock2.R.id.day1, com.finchuk.clock2.R.id.day2, com.finchuk.clock2.R.id.day3, com.finchuk.clock2.R.id.day4, com.finchuk.clock2.R.id.day5, com.finchuk.clock2.R.id.day6})
    ToggleButton[] mDays;
...
//                listener.onListItemUpdate(getAlarm(), getAdapterPosition());
    ...
    public void onBind(Alarm alarm) {
        super.onBind(alarm);
        mRingtonePickerController.tryRestoreCallback(makeTag(com.finchuk.clock2.R.id.ringtone));
        bindDays(alarm);
        bindRingtone();
    ...
    @OnClick(com.finchuk.clock2.R.id.ok)
    void save() {
        // TODO
    }
...
//    }
    ...
    @OnClick(com.finchuk.clock2.R.id.ringtone)
...
//        ((Activity) getContext()).startActivityForResult(intent, AlarmsFragment.REQUEST_PICK_RINGTONE);
        ...
        mRingtonePickerController.show(getSelectedRingtoneUri(), makeTag(com.finchuk.clock2.R.id.ringtone));
    }
    ...
    @OnClick({ com.finchuk.clock2.R.id.day0, com.finchuk.clock2.R.id.day1, com.finchuk.clock2.R.id.day2, com.finchuk.clock2.R.id.day3, com.finchuk.clock2.R.id.day4, com.finchuk.clock2.R.id.day5, com.finchuk.clock2.R.id.day6 })
