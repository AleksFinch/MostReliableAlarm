...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_SHOW_SNOOZING = "com.finchuk.clock2.action.SHOW_SNOOZING";
    public static final String EXTRA_ALARM = "com.finchuk.clock2.extra.ALARM";
