...
package com.finchuk.clock2.dialogs;
...
public final class TimePickerDialogController extends DialogFragmentController<BottomSheetTimePickerDialog> {
    ...
    public void show(int initialHourOfDay, int initialMinute, String tag) {
        ...
        String prefTimePickerStyle = prefs.getString(mContext.getString(com.finchuk.clock2.R.string.key_time_picker_style), numpadStyle);
        ...
        if (isNumpadStyle || isGridStyle) {
            ...
            String prefTheme = prefs.getString(mContext.getString(com.finchuk.clock2.R.string.key_theme), themeLight);
