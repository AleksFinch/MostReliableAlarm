...
public class TimerNotificationService extends ChronometerNotificationService {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION = "com.finchuk.clock2.timers.action.CANCEL_NOTIFICATION";
    public static final String ACTION_ADD_ONE_MINUTE = "com.finchuk.clock2.timers.action.ADD_ONE_MINUTE";

    public static final String EXTRA_TIMER = "com.finchuk.clock2.timers.extra.TIMER";
    private static final String EXTRA_CANCEL_TIMER_ID = "com.finchuk.clock2.timers.extra.CANCEL_TIMER_ID";
    ...
    protected int getSmallIcon() {
        return com.finchuk.clock2.R.drawable.ic_timer_24dp;
    }
    ...
    private void syncNotificationWithTimerState(long id, boolean running) {
        ...
        clearActions(id);
        addAction(ACTION_ADD_ONE_MINUTE, com.finchuk.clock2.R.drawable.ic_add_24dp, getString(com.finchuk.clock2.R.string.minute), id);
